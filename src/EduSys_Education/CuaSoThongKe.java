...
public class CuaSoThongKe extends javax.swing.JDialog {
    ...
    void init(){
        fillComboBoxKhoaHoc();
        fillLuongNguoiHoc();
        fillLuongThongKeDiem();
        fillComboBoxNam();
      
    }
    
    CuaSoThongKe(int thutu){
        initComponents();
        setLocationRelativeTo(null);
        setResizable(false);
        init();
    ...
    void fillComboBoxKhoaHoc(){
        DefaultComboBoxModel com = (DefaultComboBoxModel) cboKhoaHoc.getModel();
    ...
    void fillLuongThongKeDiem(){
        DefaultTableModel model = (DefaultTableModel) tblDiemChuyenCan.getModel();
        model.setRowCount(0);
    ...
    void fillComboBoxNam(){
        DefaultComboBoxModel com = (DefaultComboBoxModel) cboNam.getModel();
        com.removeAllElements();
        List<Integer> list = khdao.selectYears();
        for (Integer integer : list) {
            com.addElement(integer);
        }
    }
    
    void fillTbaleDoanhThu(){
    ...
    private void initComponents() {
        ...
        tblDiemChuyenCan = new javax.swing.JTable();
        ...
        tblDiemChuyenCan.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane3.setViewportView(tblDiemChuyenCan);
    ...
    private javax.swing.JTable tblDiemChuyenCan;
